    ...
    <div className="flex justify-between items-center p-4">
      ...
      <div className="flex gap-3">
        <div className="relative w-[320px] flex gap-2 bg-base-500 rounded-full">
          <input
            type="search"
            className=" text-base-200 py-1 pl-3 w-full border rounded-full border-base-400"
        ...
        <button className="text-base-100 flex gap-2 items-center bg-base-500 py-2 px-3 rounded-full cursor-pointer border border-base-400">
          <span>
            <Image src={arrow} alt="" />
          </span>
          Acesso
